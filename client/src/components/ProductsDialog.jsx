...
import ValidationErrorDisplay from "./../components/ValidationErrors";
  ...
  export default function ProductsDialog({product, handleUpdateProducts}) {
    ...
    return (
        <>
            {formType === 'create' && (
                <button aria-label="Open Create Product Form button" onClick={handleOpen} className="bg-primaryBlue text-white p-1 rounded-full px-3 flex h-full items-center justify-between">
                    <p className="nunito text-md pr-2 self-end">Add</p>
