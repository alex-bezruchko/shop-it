...
export default function CompleteList({sendTo, listLoading, isLoading}) {
                        ...
                        <div className="w-full">
                            ...
                            <ul>
                                {currentLists.map(list => (
                                    <li key={list._id} className="flex w-full justify-between mb-4 items-center">
                                        ...
                                        <button aria-label="Delete List button" onClick={() => deleteList(list._id)} className="text-primaryRed ml-4 mb-0 p-1 self-center">
