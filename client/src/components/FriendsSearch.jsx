        ...
        <div className="friend-list">
            ...
            <div className="user-list mt-6">
                {users.map(searchedUser => (
                    <div key={searchedUser._id} className="flex items-center justify-between bg-white rounded-lg shadow-lg px-3 py-4 mb-4 border border-[1.5px] border-primaryBlue">
                        ...
                        {!isFriend(searchedUser._id) ? (
                            outgoingRequests?.some(request => request.receiver._id === searchedUser._id) || friendRequests?.some(request => request.sender._id === searchedUser._id) ? (
                                <div className='flex items-center'> 
                                    <span className="nunito text-md mr-2">Request Pending</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#f7a072" className="w-7 h-7">
                                ...
                                <div onClick={() => handleAddFriend(searchedUser._id)}>
                                    <div className='flex items-center'> 
                                        <span className="nunito text-md mr-2">Send Request</span>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="#0fa3b1" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#0fa3b1" className="w-7 h-7">
                            ...
                            <div className='flex items-center'> 
                                <span className="nunito text-md mr-2">Already friends</span>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="#6CB462" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#6CB462" className="w-7 h-7">
