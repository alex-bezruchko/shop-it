                                    ...
                                    <ul className="flex flex-col justify-between">
                                        {currentList.products?.map(product => (
                                            <div key={product.product._id} className="flex w-full justify-between">
                                                ...
                                                <button aria-label="" onClick={() => deleteProductFromShoppingList(product.product._id)} className="text-primaryRed ml-2 mb-4 p-0 self-center">
                            ...
                            <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-6 grid-cols-1">
                                <div className="sm:col-span-3">
                                    <div className="flex">
                                        ...
                                        <button aria-label="" style={{marginLeft: '-35px'}} className="text-primaryBlue font-bold">
