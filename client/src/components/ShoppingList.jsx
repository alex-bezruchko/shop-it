...
export default function ShoppingList() {
    ...
    function addToList(product) {
        console.log('addToList(product)', product)
        // console.log('products', products)
        // console.log('selectedProducts', selectedProducts)

        // const existing = selectedProducts;
        // if (selectedProducts.products.length !== 0) {
        //     let ifDup = selectedProducts.products.find(p => p._id === product._id);
        //     if (!ifDup) {
        ...
        //     existing.products.push(product)
        //     setSelectedProducts(existing)
        //     console.log('after existing', selectedProducts)
    ...
    return (
        <div className="flex flex-col">
            ...
            {selectedProducts.products.length < 1 && (
                <></>
                // <h2 className="nunito text-2xl pb-3 pt-5">

                //     Nothing on the list yet. Find products to add:
