            ...
            <div className="flex items-left mt-2 justify-left h-full">
                ...
                {image === '' || photo === '' ? (
                    <div className="flex flex justify-around w-full items-start">
                        ...
                        <button aria-label="" onClick={clearFile} disabled={isDisabled} className="flex text-primaryRed mx-0 text-center">
                    ...
                    <div className="flex flex-col justify-around w-full">
                        ...
                        <div className="flex">
                            <button aria-label="" disabled={isDisabled} onClick={chooseFile} className={`flex mt-4 text-white font-md py-1 px-1.5 ml-3 rounded items-center ${isDisabled ? 'bg-primaryGray' : 'bg-primaryBlue'}`}>
                                <p className="nunito px-1 py-0 text-sm">Select</p>
                                {loading ? (
                                    <div className="flex mt-0">
                                        <img src="/loading.gif" className='w-4 mx-auto '/>
                            ...
                            <button aria-label="" onClick={clearFile} disabled={isDisabled} className="flex text-primaryRed ml-0 text-center items-end mb-1">
