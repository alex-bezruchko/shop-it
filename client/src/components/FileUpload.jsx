    ...
    return (
        <div className="h-full">
            <div className="flex items-left mt-2 justify-left h-full">
                ...
                {image === '' ? (
                    <div className="flex flex justify-around w-full items-center">
                        <input id="hello123" type="file" className="items-center mr-2 py-2 pl-0 text-xs w-1/2" onChange={handleFile}/>
                        <div className="flex justify-between items-center w-1/2">
                            <button onClick={chooseFile} className="flex bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-1.5 ml-3 rounded">
