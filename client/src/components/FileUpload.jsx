        ...
        <div className="h-full">
            <div className="flex items-left mt-2 justify-left h-full">
                <div className="flex flex-col w-3/4 justify-around">
                    <input id="hello123" type="file" className="mr-2 py-2 pl-3" onChange={handleFile}/>
                    <div className="flex justify-between">
                        <button onClick={chooseFile} className="flex bg-blue-500 mt-4 hover:bg-blue-700 text-white font-bold py-2 px-2 ml-3 rounded">
                            <p className="nunito pr-2 pl-3">Select image</p>
                ...
                <button onClick={clearFile} disabled={isDisabled} className="flex text-primaryRed mx-auto text-center items-center">
