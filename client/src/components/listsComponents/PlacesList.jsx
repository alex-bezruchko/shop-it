...
function FavoritesList() {
    ...
    return (
        <div className="friend-list">
            ...
            {loading ? (
                <div>
                    <img src="/loading.gif" className='size-10 mx-auto mt-6 mb-6'/>
                </div>
            ) : (
                <div className="user-list">
                    {places.map(place =>
                        <div key={place.place_id} className="w-full flex my-5 flex-col items-center justify-between bg-white border border-[1.5px] border-primaryBlue rounded-lg shadow-lg py-3 px-3 mb-4">
                            ...
                            <svg onClick={() => removePlace(place)} xmlns="http://www.w3.org/2000/svg" fill="rgb(247, 160, 114)" viewBox="0 0 24 24" strokeWidth="1.5" stroke='none' className="min-w-[40px] h-[40px] text-primaryBlue">
