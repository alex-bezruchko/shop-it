                        ...
                        <div className="w-full">
                            ...
                            <div key={request.sender._id} className="flex items-center justify-between bg-white rounded-lg shadow-lg px-3 py-4 mb-4 border border-[1.5px] border-primaryBlue">
                                ...
                                <div className="flex items-center">
                                    <button aria-label="Accept Friend Request button" onClick={() => handleAcceptRequest(request.sender._id)} className="mr-2">
                                    ...
                                    <button aria-label="Decline Friend Request button" onClick={() => handleDeclineRequest(request.sender._id)}>
